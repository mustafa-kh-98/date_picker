...
import 'package:flutter_datetime_picker/src/datetime_picker_theme.dart' as th;
...
class _DatePickerRoute<T> extends PopupRoute<T> {
  _DatePickerRoute({
    ...
    BasePickerModel? pickerModel,
        ...
        this.theme = theme ?? th.DatePickerTheme(),
  ...
  final th.DatePickerTheme theme;
...
//    print('refreshScrollOffset ${widget.pickerModel.currentRightIndex()}');
  ...
  Widget build(BuildContext context) {
    th.DatePickerTheme theme = widget.route.theme;
  ...
  Widget _renderPickerView(th.DatePickerTheme theme) {
  ...
  Widget _renderItemView(th.DatePickerTheme theme) {
    return Container(
      color: theme.backgroundColor,
  ...
  // Title View
  Widget _renderTitleActionsView(th.DatePickerTheme theme) {
